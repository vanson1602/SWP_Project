                    ...
                    <div class="container">
                        <nav class="nav">
                            ...
                            <ul class="nav-links" id="navLinks">
                                ...
                                <li><a href="/doctor/schedules"><i class="bi bi-person-badge"></i>Gửi lịch bận</a>
                                </li>
                ...
                <section class="py-5 bg-light">
                    <div class="container text-center">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="card h-100 shadow-sm border-0 p-3">
                                    <div class="bg-info text-white rounded-circle d-flex justify-content-center align-items-center mx-auto mb-3"
                                        style="width: 60px; height: 60px;">
