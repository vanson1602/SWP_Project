                        ...
                        <%! private String formatDateTime(LocalDateTime dateTime) { if (dateTime==null) return "" ;
                            ...
                            <head>
                                ...
                                <style>
                                    ...
                                    /* Medical Record Details Styling */
                                    ...
                                    .symptoms-diagnosis p:last-child {
                                        margin-bottom: 0 !important;
                                    }

                                    .symptoms-diagnosis p strong {
                                        color: #1e40af;
                                        min-width: 120px;
                                        display: inline-block;
                                        margin-right: 10px;
                                    ...
                                    .symptoms-diagnosis p strong::before {
                                        margin-right: 6px;
                                        font-size: 1rem;
                                    }
                                    ...
                                    .treatment-plan p strong::before {
                                        content: "📅";
                                        margin-right: 6px;
                                        font-size: 1rem;
                                    }
                                    ...
                                    .medical-record-details h5.text-primary {
                                    ...
                                    .medical-record-details h5::after {
                                        content: '';
                                        position: absolute;
                                        bottom: 0;
                                        left: 0;
