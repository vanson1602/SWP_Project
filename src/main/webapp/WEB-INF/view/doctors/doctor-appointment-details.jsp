            ...
            <div class="details-card">
                ...
                <c:if test="${not empty appointment}">
                        ...
                        <div class="patient-details-row mt-3">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="info-card">
                                        <div class="info-label-horizontal d-flex align-items-center">
                                            <i class="bi bi-envelope-at me-2 text-info"></i> Email
                                        </div>
                                        <div class="info-value-horizontal">
                                            <c:choose>
                    ...
                    <div class="medical-records-section mt-4">
                        <ul class="nav nav-tabs modern-tabs" id="medicalRecordTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="notification-tab" data-bs-toggle="tab" 
                                    ...
                                    <span class="badge bg-gradient bg-danger rounded-pill ms-1">2</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-pane fade" id="prescription" role="tabpanel">
                                <div class="prescription-content">
                                    <c:choose>
                                        <c:when test="${not empty examination}">
                                            <!-- Form kê đơn thuốc -->
                                            <div class="prescription-form-container" id="prescriptionFormContainer">
                                                <button type="button" class="add-prescription-btn" id="addPrescriptionBtn">
                                                    <i class="bi bi-plus-circle me-2"></i>
                                                    Thêm thuốc mới
                                                </button>
                                                
                                                <form id="prescriptionForm" style="display: none;" class="mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-end gap-2 mt-3">
                                                        ...
                                                        <button type="submit" class="btn btn-success" id="savePrescriptionBtn">
                                                            <i class="bi bi-save me-1"></i>Lưu đơn thuốc
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <c:choose>
                                                <c:when test="${not empty examination.prescriptions}">
                                                    <div class="prescription-list">
                                                        <h6 class="mb-3">
                                                            <i class="bi bi-list-ul me-2"></i>Đơn thuốc đã kê
                                                        </h6>
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody id="existingPrescriptions">
                                                                        ...
                                                                        <tr data-prescription-id="${prescription.prescriptionID}">
                                                                            ...
                                                                            <td>
                                                                                <div class="text-muted small">
                                                                                    ${not empty prescription.instructions ? prescription.instructions : 'Không có hướng dẫn'}
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                ...
                                                <c:otherwise>
                                                    <div class="empty-state" id="emptyPrescriptionState">
                    ...
                    <div class="action-card mt-4">
                        <div class="action-buttons d-flex justify-content-around mb-3 gap-3">
                            <c:choose>
                                <c:when test="${not empty examination}">
                                    <a href="<c:url value='/doctor/appointments/${appointment.appointmentID}/examination/edit' />" class="btn-action btn-create modern-btn">
                                        <i class="bi bi-pencil-square me-2"></i>
                                        Sửa Hồ sơ Khám bệnh
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="<c:url value='/doctor/appointments/${appointment.appointmentID}/examination/create' />" class="btn-action btn-create modern-btn">
                                        <i class="bi bi-file-earmark-medical me-2"></i>
                                        Tạo Hồ sơ Khám bệnh
                                    </a>
                                </c:otherwise>
                            </c:choose>
                            <a href="#" class="btn-action btn-history modern-btn">
                                <i class="bi bi-clock-history me-2"></i>
                                Xem Lịch sử Khám bệnh
                            </a>                  
                            <a href="/doctor/appointments" class="btn-action btn-back modern-btn">
