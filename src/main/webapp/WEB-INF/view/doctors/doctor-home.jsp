        ...
        <div class="container">
            <nav class="nav">
                ...
                <ul class="nav-links" id="navLinks">
                    <li><a href="<c:url value='/doctor/home' />" class="active"><i class="bi bi-house-door"></i> Trang chủ</a></li>
                    ...
                    <li><a href="<c:url value='/doctor/appointments' />"><i class="bi bi-calendar-check"></i> Lịch hẹn</a></li>
                </ul>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <form action="<c:url value='/doctor/login' />" method="post" class="d-inline">
                                ...
                                <c:if test="${not empty error}"><p class="text-danger text-center">${error}</p></c:if>
                            </form>
                        </c:otherwise>
                    </c:choose>
                </div>
            ...
            <div class="row g-4">
                <div class="col-md-3 col-sm-6">
                    <div class="card h-100 shadow-sm border-0 p-3">
                        <div class="bg-primary text-white rounded-circle d-flex justify-content-center align-items-center mx-auto mb-3" style="width: 60px; height: 60px;">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card h-100 shadow-sm border-0 p-3">
                        <div class="bg-danger text-white rounded-circle d-flex justify-content-center align-items-center mx-auto mb-3" style="width: 60px; height: 60px;">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card h-100 shadow-sm border-0 p-3">
                        <div class="bg-info text-white rounded-circle d-flex justify-content-center align-items-center mx-auto mb-3" style="width: 60px; height: 60px;">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card h-100 shadow-sm border-0 p-3">
                        <div class="bg-success text-white rounded-circle d-flex justify-content-center align-items-center mx-auto mb-3" style="width: 60px; height: 60px;">
          ...
          <div class="row align-items-center">
            <div class="col-lg-7 mb-4 mb-lg-0">
              ...
              <p class="lead" style="color: #333;">
                HealthCare+ là hệ thống đặt lịch khám trực tuyến hiện đại, giúp bạn kết nối dễ dàng với đội ngũ bác sĩ giàu kinh nghiệm tại phòng khám.<br>
                Chúng tôi mang đến giải pháp chăm sóc sức khỏe tiện lợi, nhanh chóng và hiệu quả – giúp bạn chủ động hơn trong việc bảo vệ sức khỏe cho bản thân và gia đình.
              </p>
              <div class="mt-4">
                <h5 class="fw-semibold mb-3" style="color: #1976d2;">💡 Tại sao nên chọn HealthCare+?</h5>
                <ul class="list-unstyled fs-5">
                  <li class="mb-2"><span class="me-2">🔍</span>Tìm bác sĩ dễ dàng theo chuyên khoa hoặc lịch làm việc</li>
                  <li class="mb-2"><span class="me-2">📅</span>Đặt lịch khám nhanh chóng, không cần chờ đợi</li>
                  <li class="mb-2"><span class="me-2">📄</span>Xem lại lịch sử khám bệnh và theo dõi quá trình điều trị</li>
            ...
            <div class="col-lg-5 text-center">
              <img src="/uploads/health.png" alt="HealthCare+ Welcome" class="img-fluid rounded-4 shadow w-100" style="object-fit: cover; height: 100%;">
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container py-4">
          <div class="row">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
              <div class="p-3 rounded-4" style="background: linear-gradient(135deg, #7ec6f7 0%, #42a5f5 100%); color: #fff; border: 4px solid #b3d1f5;">
                ...
                <div class="mb-3 d-flex align-items-start">
                  ...
                  <a href="mailto:contact.us@umcclinic.com.vn" style="color: #fff; text-decoration: none; word-break: break-all;">
            ...
            <!-- Policies -->
            <div class="col-md-4 mb-4 mb-md-0">
              <div class="p-3 rounded-4" style="background: linear-gradient(135deg, #7ec6f7 0%, #42a5f5 100%); color: #fff; border: 4px solid #b3d1f5; height: 100%;">
                <h6 class="fw-bold mb-3 text-center">CHÍNH SÁCH</h6>
                <ul class="list-unstyled">
                  <li class="mb-3 text-center"><a href="#" class="text-decoration-none text-white"><i class="bi bi-chevron-right me-2"></i>Chính sách bảo mật</a></li>
                  <li class="mb-3 text-center"><a href="#" class="text-decoration-none text-white"><i class="bi bi-chevron-right me-2"></i>Điều khoản sử dụng</a></li>
                  <li class="mb-3 text-center"><a href="#" class="text-decoration-none text-white"><i class="bi bi-chevron-right me-2"></i>Chính sách thanh toán</a></li>
                  <li class="mb-3 text-center"><a href="#" class="text-decoration-none text-white"><i class="bi bi-chevron-right me-2"></i>Chính sách hoàn hủy</a></li>
                  <li class="mb-3 text-center"><a href="#" class="text-decoration-none text-white"><i class="bi bi-chevron-right me-2"></i>Chính sách bảo hành</a></li>
                </ul>
              </div>
            </div>
