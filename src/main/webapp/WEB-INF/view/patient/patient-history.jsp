      ...
      <div class="card-container">
        <c:forEach var="a" items="${appointment}" varStatus="i">
          <div class="card">
            ...
            <p>
              <span class="label">Hồ sơ bệnh án: </span
              ><a href="/medical-history/medical-record/${a.appointmentID}"
                >chi tiết</a
              >
            </p>
            <p>
              <span class="label">Đơn thuốc khám bệnh: </span
              ><a href="/medical-history/prescription/${a.appointmentID}"
                >chi tiết</a
              >
            </p>
          </div>
