        ...
        <%@ page contentType="text/html;charset=UTF-8" language="java" pageEncoding="UTF-8" %>
            ...
            <body>
                ...
                <div class="feedback-form-wrapper">
                    <h2><i class="bi bi-pencil-square me-2"></i> Chỉnh sửa Feedback</h2>

                    <form:form method="post" modelAttribute="feedback"
                        action="${pageContext.request.contextPath}/feedback/update">
                        ...
                        <div class="mb-3">
                            ...
                            <form:textarea path="comment" cssClass="form-control" rows="4"
                                placeholder="Chỉnh sửa trải nghiệm của bạn..." />
                        </div>
                        ...
                        <button type="submit" class="btn btn-submit">
                            <i class="bi bi-check-circle-fill me-2"></i> Cập nhật Feedback
                        </button>
                    </form:form>
                </div>
                ...
                <script>
                    ...
                    document.querySelectorAll(".star-rating").forEach(starGroup => {
                        ...
                        if (initial) updateStars(initial);
                    });

                    // Loading animation khi submit
                    document.querySelector('form').addEventListener('submit', function (e) {
                        const requiredRating = document.getElementById('ratingInput');
                        if (!requiredRating.value) {
                            e.preventDefault();
                            alert('Vui lòng chọn đánh giá chung!');
                            return;
                        }

                        const btn = document.querySelector('.btn-submit');
                        btn.innerHTML = '<i class="bi bi-arrow-clockwise spin me-2"></i> Đang cập nhật...';
                        btn.disabled = true;
                    });
                </script>
