                ...
                <div class="container">
                    ...
                    <div class="content-container">
                        ...
                        <div class="nav-buttons">
                            <a href="${pageContext.request.contextPath}/appointments/booking" class="btn btn-secondary">
                                ← Quay lại
                            </a>
                            <button id="continueBtn" class="btn btn-primary" disabled onclick="selectSpecialty()">
                                Tiếp tục →
                            </button>
                        </div>
                    </div>
