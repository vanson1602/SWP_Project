        ...
        <div class="dashboard-header">
            ...
            <div class="filter-group">
                <div class="d-flex gap-2">
                    <button class="btn btn-outline-primary filter-btn" data-filter="day">Theo Ngày</button>
                    <button class="btn btn-outline-primary filter-btn" data-filter="week">Theo Tuần</button>
                    <button class="btn btn-outline-primary filter-btn" data-filter="month">Theo Tháng</button>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card dashboard-card patient-card">
                        <div class="card-body text-center">
                            ...
                            <p class="stats-number" id="total-patients"><fmt:formatNumber value="${totalPatients}" type="number"/></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card dashboard-card appointment-card">
                        <div class="card-body text-center">
                            ...
                            <p class="stats-number" id="total-appointments"><fmt:formatNumber value="${totalAppointments}" type="number"/></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card dashboard-card revenue-card">
                        <div class="card-body text-center">
                            ...
                            <p class="stats-number" id="total-revenue"><fmt:formatNumber value="${totalRevenue}" type="currency" currencySymbol="VNĐ"/></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 mb-4">
                    <div class="card chart-card">
                        <div class="card-header">
                            ...
                            <span id="chart-title">Thống Kê Doanh Thu & Lượt Khám (7 ngày gần nhất)</span>
                        </div>
                    ...
                    <div class="card chart-card doctor-revenue-card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped align-middle" id="doctor-revenue-table">
                                    ...
                                    <tbody>
                                        <c:forEach items="${doctorRevenue}" var="revenue" varStatus="status">
                                                    <tr class="text-center">
                                                        <td>${status.index + 1}</td>
                                                <td>
                                                                    <c:choose>
                                                        <c:when test="${not empty revenue.doctor and not empty revenue.doctor.user}">
                                                        ...
                                                        <c:otherwise>
                                                            ${revenue.doctor.user.firstName} ${revenue.doctor.user.lastName}
                                                        </c:otherwise>
                                                                    </c:choose>
                                                        </td>
                                                <td><fmt:formatNumber value="${revenue.fee}" type="currency" currencySymbol="VND" maxFractionDigits="0"/></td>
                                                <td>${revenue.totalExaminations}</td>
                                                <td><fmt:formatNumber value="${revenue.totalRevenue}" type="currency" currencySymbol="VND" maxFractionDigits="0"/></td>
                                                    </tr>
                                                </c:forEach>
