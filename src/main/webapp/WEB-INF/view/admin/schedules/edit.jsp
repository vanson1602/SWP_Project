<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <body>
            <div class="container">
                <div class="page-title">Edit Doctor Schedule</div>
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card p-4 bg-white">
                            <div class="card-body">
                                <form:form action="/admin/schedules/update" method="post" modelAttribute="schedule">
                                    <form:hidden path="scheduleID" />

                                    <div class="mb-3">
                                        <label class="form-label">Doctor ID</label>
                                        <form:input path="doctor.doctorID" cssClass="form-control" readonly="true" />
                                    </div>
                                ...
                                <div class="d-grid">
                                    <a href="/admin/schedules/list" class="btn btn-back">← Back to List</a>
                                </div>
                            </div>
                        </div>
                    </div>
