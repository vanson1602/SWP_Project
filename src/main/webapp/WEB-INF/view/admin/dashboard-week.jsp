...
<head>
    ...
    <title>Dashboard Admin - Thống Kê Theo Tuần</title>
...
<body style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); min-height: 100vh;">
    <div class="container mt-4">
            ...
            <div class="col-lg-8 mb-4">
                <div class="card chart-card">
                    <div class="card-header">
                        ...
                        Thống Kê Doanh Thu & Lượt Khám (Tuần hiện tại)
                    </div>
        ...
        <!-- Doanh Thu Bác Sĩ Tuần Này -->
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="card chart-card doctor-revenue-card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <i class="fas fa-money-bill-wave me-2"></i>
                        <span class="fw-bold">Doanh Thu Bác Sĩ Tuần Này</span>
                    </div>
                    <div class="card-body">
