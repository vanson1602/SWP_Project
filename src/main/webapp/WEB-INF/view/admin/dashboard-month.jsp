...
<head>
    ...
    <title>Dashboard Admin - Thống Kê Theo Tháng</title>
...
<body style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); min-height: 100vh;">
    <div class="container mt-4">
        ...
        <!-- Doanh Thu Bác Sĩ Tháng Này -->
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="card chart-card doctor-revenue-card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <i class="fas fa-money-bill-wave me-2"></i>
                        <span class="fw-bold">Doanh Thu Bác Sĩ Tháng Này</span>
                    </div>
                    <div class="card-body">
        ...
        const dates = dailyStats.map((item, index) => {
            try {
                if (item && item.yearMonth) {
                    const date = new Date(item.yearMonth); // Giả sử yearMonth là 'YYYY-MM'
